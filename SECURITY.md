...
Kungfu.js is pre-1.0. We currently ship security fixes for the latest
...
If you discover a security vulnerability in Kungfu.js, **please do not
open a public GitHub issue**. Instead, email security@kungfu.js.org with:
...
Kungfu.js is **secure-by-default**. The framework installs the following
...
- [ ] Put Kungfu behind a TLS-terminating reverse proxy (nginx, Caddy, etc.)
...
- `#![forbid(unsafe_code)]` in `kungfu-core`. All `unsafe` is concentrated
